  ...
  return (
    <Card className="w-full max-w-md mx-auto shadow-lg">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-2xl font-headline mt-2">Doctor Registration</CardTitle>
      ...
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input id="name" type="text" placeholder="Dr. John Doe" {...register("name")} />
            {errors.name && <p className="text-sm text-destructive">{errors.name.message}</p>}
          </div>
          <div className="space-y-2">
            <Label htmlFor="email">Email</Label>
            <Input id="email" type="email" placeholder="doctor@yourhospital.com" {...register("email")} />
          ...
          <div className="space-y-2">
            ...
            <Input id="specialty" type="text" placeholder="e.g., Pediatrics" {...register("specialty")} />
            {errors.specialty && <p className="text-sm text-destructive">{errors.specialty.message}</p>}
          </div>
           <div className="space-y-2">
            <Label htmlFor="hospitalId">Hospital ID</Label>
            <Input id="hospitalId" type="text" placeholder="Provided by your administrator" {...register("hospitalId")} />
