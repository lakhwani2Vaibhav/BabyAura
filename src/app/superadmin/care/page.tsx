...
export default function SuperAdminCarePage() {
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="sm:max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Share expert knowledge and official resources with parents.
              </DialogDescription>
            </DialogHeader>
            <Form {...form}>
              <form
            ...
            <Card key={article.id} className="flex flex-col">
              ...
              <CardFooter>
                 <Button variant="outline" size="sm" asChild>
                    <Link href={`/parent/care/${article.id}`}>View as Parent</Link>
                 </Button>
              </CardFooter>
            </Card>
          ))
